...
const SOURCES = {
  ...
  'latin-america': [
    ...
    { name: 'El Pais America', rssUrl: 'https://feeds.elpais.com/mrss-s/pages/ep/site/english.elpais.com/portada', country: ['Spain', 'Mexico', 'Argentina', 'Colombia', 'Chile'], tier: 'mainstream', language: 'English', region: 'latin-america' },
    { name: 'Folha de S.Paulo International', rssUrl: 'https://www1.folha.uol.com.br/internacional/en/rss091.xml', country: ['Brazil'], tier: 'mainstream', language: 'English', region: 'latin-america' },
    { name: 'Infobae English', rssUrl: 'https://www.infobae.com/feeds/rss/', country: ['Argentina', 'Mexico', 'Colombia'], tier: 'mainstream', language: 'English', region: 'latin-america' },
    { name: 'Americas Quarterly', rssUrl: 'https://www.americasquarterly.org/feed/', country: ['Brazil', 'Mexico', 'Argentina', 'Colombia', 'Chile', 'Peru', 'Venezuela'], tier: 'think-tank-academic', language: 'English', region: 'latin-america' },
  ...
  'africa': [
    ...
    { name: 'The East African', rssUrl: 'https://www.theeastafrican.co.ke/rss', country: ['Kenya', 'Tanzania', 'Uganda', 'Rwanda', 'Burundi'], tier: 'mainstream', language: 'English', region: 'africa' },
    { name: 'Daily Nation', rssUrl: 'https://nation.africa/kenya/news/rss.xml', country: ['Kenya'], tier: 'mainstream', language: 'English', region: 'africa' },
  ...
  'southeast-asia': [
    ...
    { name: 'The Straits Times', rssUrl: 'https://www.straitstimes.com/news/world/rss.xml', country: ['Singapore'], tier: 'mainstream', language: 'English', region: 'southeast-asia' },
    { name: 'The Business Times Singapore', rssUrl: 'https://www.businesstimes.com.sg/rss/international', country: ['Singapore'], tier: 'mainstream', language: 'English', region: 'southeast-asia' },
    { name: 'Today Online', rssUrl: 'https://www.todayonline.com/rss.xml', country: ['Singapore'], tier: 'mainstream', language: 'English', region: 'southeast-asia' },
    { name: 'The Independent Singapore', rssUrl: 'https://theindependent.sg/feed/', country: ['Singapore'], tier: 'independent-critical', language: 'English', region: 'southeast-asia' },
    { name: 'Coconuts Media', rssUrl: 'https://coconuts.co/feed/', country: ['Singapore', 'Thailand', 'Indonesia', 'Philippines'], tier: 'independent-critical', language: 'English', region: 'southeast-asia' },
  ...
  'global': [
    ...
    // ── Climate / environment specialist feeds ──
    { name: 'Carbon Brief', rssUrl: 'https://www.carbonbrief.org/feed/', country: ['UK'], tier: 'think-tank-academic', language: 'English', region: 'global' },
    { name: 'Climate Home News', rssUrl: 'https://www.climatechangenews.com/feed/', country: ['UK'], tier: 'independent-critical', language: 'English', region: 'global' },
    { name: 'DeSmog', rssUrl: 'https://www.desmog.com/feed/', country: ['UK', 'US'], tier: 'independent-critical', language: 'English', region: 'global' },
    { name: 'Grist', rssUrl: 'https://grist.org/feed/', country: ['US'], tier: 'independent-critical', language: 'English', region: 'global' },
    { name: 'Inside Climate News', rssUrl: 'https://insideclimatenews.org/feed/', country: ['US'], tier: 'independent-critical', language: 'English', region: 'global' },
...
// Sector keywords — expanded taxonomy covering 15 named sectors plus
// a free-text "Other" bucket (no keyword list; matched only by the
// literal term the user typed).
const SECTOR_KEYWORDS = {
  'Geopolitics & International Relations': ['geopolitics', 'geopolitical', 'diplomacy', 'diplomatic', 'sanctions', 'foreign policy', 'foreign minister', 'treaty', 'alliance', 'sovereignty', 'territorial', 'border dispute', 'ambassador', 'bilateral', 'multilateral', 'summit', 'peace talks', 'ceasefire', 'annexation', 'proxy war', 'frozen conflict', 'non-proliferation', 'regime change', 'state visit', 'diplomatic ties', 'expel diplomat', 'consulate', 'embassy', 'UN', 'NATO', 'ASEAN', 'G7', 'G20', 'BRICS', 'European Union'],
  'Economics & Trade': ['economy', 'economic', 'trade deal', 'trade war', 'tariff', 'gdp', 'inflation', 'recession', 'supply chain', 'trade deficit', 'trade surplus', 'export', 'import', 'fdi', 'foreign investment', 'devaluation', 'austerity', 'stimulus', 'subsidy', 'embargo', 'commodity', 'WTO', 'IMF', 'World Bank', 'free trade', 'protectionism', 'decoupling', 'customs', 'trade agreement'],
  'Technology & AI': ['artificial intelligence', 'ai regulation', 'cyber attack', 'cybersecurity', 'semiconductor', 'chip', 'quantum computing', 'data privacy', 'surveillance', 'tech regulation', 'big tech', 'social media', 'deepfake', 'autonomous', '5g', '6g', 'tech decoupling', 'digital sovereignty', 'spyware', 'encryption', 'machine learning', 'startup', 'data center', 'cloud computing', 'algorithm'],
  'Climate & Environment': ['climate change', 'global warming', 'net zero', 'carbon emissions', 'paris agreement', 'cop28', 'cop29', 'cop30', 'carbon tax', 'carbon credit', 'drought', 'flooding', 'wildfire', 'sea level', 'biodiversity', 'deforestation', 'pollution', 'ecosystem', 'greenhouse gas', 'hurricane', 'typhoon', 'environmental', 'conservation', 'endangered'],
  'Energy & Resources': ['oil price', 'opec', 'natural gas', 'lng', 'solar power', 'wind power', 'nuclear energy', 'fossil fuel', 'energy transition', 'renewable energy', 'pipeline', 'refinery', 'critical minerals', 'lithium', 'cobalt', 'rare earth', 'mining', 'copper', 'coal', 'hydrogen', 'energy security', 'grid', 'power plant', 'crude', 'petroleum', 'electricity', 'ev battery'],
  'Defence & Security': ['defense', 'defence', 'military', 'armed forces', 'security', 'weapons', 'terrorism', 'missile', 'arms deal', 'arms race', 'nuclear weapon', 'air strike', 'drone strike', 'counterterrorism', 'insurgency', 'guerrilla', 'naval', 'aircraft carrier', 'conscription', 'military exercise', 'defence budget', 'peacekeeping', 'war crime', 'ammunition', 'artillery', 'coup', 'junta', 'army', 'navy', 'air force'],
  'Finance & Markets': ['stock market', 'bond yield', 'interest rate', 'fiscal policy', 'monetary policy', 'central bank', 'currency', 'exchange rate', 'sovereign debt', 'equity', 'hedge fund', 'private equity', 'ipo', 'merger', 'acquisition', 'buyout', 'wall street', 'ftse', 'nikkei', 'shanghai composite', 'nasdaq', 'fed', 'ecb', 'boj', 'pboc', 'bond', 'treasury yield', 'default', 'debt crisis', 'credit rating', 'dollar', 'euro', 'yuan', 'yen', 'rupee'],
  'Public Policy & Governance': ['government', 'parliament', 'congress', 'legislation', 'regulation', 'governance', 'public policy', 'ministry', 'bureaucracy', 'reform', 'policy', 'election', 'voting', 'referendum', 'coalition', 'cabinet', 'prime minister', 'president', 'chancellor', 'premier', 'senate', 'house of representatives', 'governor', 'mayor', 'public service'],
  'Society & Culture': ['society', 'culture', 'religion', 'religious', 'protest', 'demonstration', 'identity', 'gender', 'race', 'ethnic', 'diversity', 'inequality', 'social movement', 'community', 'generational', 'youth', 'demographic', 'civil unrest', 'strike', 'labour dispute', 'union', 'education', 'curriculum', 'tradition', 'heritage'],
  'Health & Pandemic': ['pandemic', 'epidemic', 'outbreak', 'biotech', 'pharmaceutical', 'vaccine', 'disease', 'virus', 'who', 'world health organization', 'public health', 'drug approval', 'clinical trial', 'antimicrobial', 'genomics', 'biosecurity', 'health crisis', 'hospital', 'mortality', 'infection rate', 'quarantine', 'variant', 'fda', 'cdc', 'healthcare', 'mental health', 'medicine'],
  'Space & Frontier Tech': ['space launch', 'satellite', 'rocket', 'nasa', 'spacex', 'blue origin', 'orbital', 'mars mission', 'moon landing', 'asteroid', 'space station', 'iss', 'space force', 'anti-satellite', 'space debris', 'space race', 'deep space', 'james webb', 'artemis', 'quantum', 'fusion', 'crispr', 'gene editing', 'synthetic biology', 'nanotech', 'robotics', 'humanoid'],
  'Media & Disinformation': ['media', 'journalist', 'press', 'freedom of press', 'censorship', 'disinformation', 'misinformation', 'propaganda', 'deepfake', 'social media ban', 'platform regulation', 'content moderation', 'fact check', 'narrative', 'state media', 'independent media', 'news outlet', 'newsroom', 'editor', 'reporter', 'blogger', 'influencer'],
  'Human Rights & Migration': ['human rights', 'refugee', 'migrant', 'migration', 'asylum', 'displaced', 'persecution', 'political prisoner', 'activist', 'detention', 'torture', 'unhcr', 'amnesty international', 'human rights watch', 'minority', 'indigenous', 'apartheid', 'discrimination', 'genocide', 'ethnic cleansing', 'forced labour', 'trafficking', 'border crossing', 'deportation', 'undocumented'],
  'Legal & Regulatory': ['lawsuit', 'court', 'ruling', 'judgment', 'verdict', 'legal', 'regulator', 'antitrust', 'compliance', 'constitutional', 'supreme court', 'prosecution', 'indictment', 'sentence', 'guilty', 'acquitted', 'injunction', 'subpoena', 'investigation', 'probe', 'fine', 'penalty', 'settlement', 'arbitration', 'class action', 'intellectual property', 'patent'],
  'Food & Agriculture': ['food', 'agriculture', 'farming', 'crop', 'harvest', 'livestock', 'grain', 'wheat', 'corn', 'rice', 'fertilizer', 'famine', 'food security', 'food supply', 'fao', 'fishery', 'aquaculture', 'dairy', 'meat', 'drought impact on crops', 'locust', 'pest', 'seed', 'gmo', 'organic', 'soybean']
};
